 ...
 *
 */
public class TiktokServiceImpl implements TiktokAPI{
	...
	public static void main (String[] agrs) throws Exception {
		TiktokServiceImpl a = new TiktokServiceImpl();
		ListCommentsResponse us = a.listComments(ListCommentsRequest.builder().count("10").aweme_id("6660790233350688001").build());
		System.out.println("");
	}
